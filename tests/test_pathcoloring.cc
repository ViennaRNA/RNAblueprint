...
BOOST_AUTO_TEST_CASE (generatePathSeq) {
  ...
  initialize_library(true, *(new std::mt19937(1)) );

  std::vector < TestCase > testcases;
  testcases.push_back(TestCase(G, G, 2, 2, {G, C, G}));
  testcases.push_back(TestCase(N, G, 3, 5, {U, G, C, G}));
  testcases.push_back(TestCase(C, N, 4, 5, {C, G, U, A, U}));
  testcases.push_back(TestCase(N, N, 1, 6, {A, U}));
  testcases.push_back(TestCase(N, N, 5, 42, {A, U, A, U, G, U}));
  testcases.push_back(TestCase(-1, A, 6, 5, {A, U, G, U, A, U}));
  testcases.push_back(TestCase(-1, G, 6, 13, {G, C, G, U, A, U}));
  testcases.push_back(TestCase(-1, N, 4, 14, {U, G, U, A}));
  testcases.push_back(TestCase(C, R, 1, 1, {C, G}));
  testcases.push_back(TestCase(R, Y, 1, 3, {A, U}));
  testcases.push_back(TestCase(H, A, 2, 1, {A, U, A}));
  testcases.push_back(TestCase(-1, N, 4, 14, {U, G, U, A}));
  testcases.push_back(TestCase(-1, A, 4, 2, {A, U, G, U}));
  testcases.push_back(TestCase(-1, U, 4, 5, {U, G, U, A}));
  testcases.push_back(TestCase(-1, G, 4, 5, {G, C, G, C}));
  testcases.push_back(TestCase(-1, C, 4, 2, {C, G, U, G}));
  testcases.push_back(TestCase(-1, R, 4, 7, {G, U, G, C}));
  testcases.push_back(TestCase(-1, V, 4, 9, {A, U, A, U}));
