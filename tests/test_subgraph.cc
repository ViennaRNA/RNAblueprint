...
BOOST_AUTO_TEST_CASE(addEdgeRepeat) {

    BOOST_TEST_MESSAGE("subgraph add edges repeatedly");
    ...
    // add edge again to G1 and propagate up and down
    add_edge(0, 1, G1);
...
BOOST_AUTO_TEST_CASE(removeEdge) {
    ...
    BOOST_TEST_MESSAGE("subgraph remove edge");
