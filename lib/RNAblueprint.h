...
namespace design {
    ...
    public:
        ...
        */
         ...
         * Use this function to set the size of the storage stack (Minimum: 1).
         *
         * \param size \b integer to set the size (>0) of the history storage container.
        */
        ...
        */
         ...
         * \return \b number of possible solutions for this sampling (number of all possible sequences minus the current one).
        */
